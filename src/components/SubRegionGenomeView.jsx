...
class SubRegionGenomeView extends Component {
    ...
    componentDidMount() {
        const { chartScale, chromosomeData = [], actions } = this.props;
        ...
        let target = document.getElementById('view-finder-window');
        ...
        actions.setRegion(getStartAndEnd(target, chartScale))
